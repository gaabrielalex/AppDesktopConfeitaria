...
public class UsuarioView extends SuperView {
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        ...
        this.displayDataInTable(this.usuarioController.select(this.edtNomeFiltro.getText(), this.edtLoginFiltro.getText()));
    ...
    public UsuarioView(UsuarioController usuarioController, DatabaseAccessComponentManager<Usuario> usuarioDBCManager, JFrame previousView) {
        ...
        //HANDLING CODES
            ...
            //Triggering methods
                ...
                this.usuarioDBCManager.setDisplayDataInTable(this::displayDataInTable);
    ...
    public void displayDataInTable(List<Usuario> usuarios) {
        //Capturando o modelo da tabela e limpando-a
        DefaultTableModel tableModel = (DefaultTableModel) this.tblUsuario.getModel();
        ...
        this.usuarioDBCManager.setDefaultTableSettings();
    }
