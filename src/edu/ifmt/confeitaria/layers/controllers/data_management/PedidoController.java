...
public class PedidoController extends SuperController<Pedido> {
    ...
    public void calculateTotalOrderValue() {
        ...
        for (ItemPedido itemPedido : this.itemPedidoDBCManager.getTemporaryTDataList().getValue()) {
            try {
                subtotal = subtotal + itemPedido.getVlrTotalItem().doubleValue();
            } catch (Exception e) {
                totalOrderValue += 0;
            }
        }
        ...
        this.pedidoView.getEdtSubTotalPedido().setText(Double.toString(subtotal));
    }
    ...
    public void modelToFields(Pedido pedido) {
        ...
        this.pedidoView.getCmbSttsPagto().setSelectedItem(pedido.getStatusPagto() == null ? null : ViewUtils.customToLowerCase( pedido.getStatusPagto().toString()));
        this.pedidoView.getCmbSttsPedido().setSelectedItem(pedido.getStatusPedido() == null ? null : ViewUtils.customToLowerCase(pedido.getStatusPedido().toString()));
